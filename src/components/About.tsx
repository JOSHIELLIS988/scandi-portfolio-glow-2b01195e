  ...
  return (
    <section id="about" className="py-20 md:py-32 bg-background">
      ...
      >
        <h2
          ref={headingRef}
          className="text-3xl md:text-4xl font-bold text-center mb-12 opacity-0 translate-y-4 transition-all duration-700 ease-out"
        >
          About
        </h2>
        <div className="max-w-3xl mx-auto space-y-6">
          <p
            ref={textRef1}
            className="text-base md:text-lg text-muted-foreground leading-relaxed opacity-0 translate-y-4 transition-all duration-700 delay-100 ease-out"
          >
          ...
          <p
            ref={textRef3}
            className="text-base md:text-lg text-muted-foreground leading-relaxed opacity-0 translate-y-4 transition-all duration-700 delay-300 ease-out"
          >
